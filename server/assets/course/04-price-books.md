...
**Use Case:** Incentivizing larger orders while keeping pricing tied to list price.
...
3. **Tiers enable volume pricing** - UNIT_PRICE, FLAT_PRICE, GRADUATED, or VOLUME_DISCOUNT_PERCENT
