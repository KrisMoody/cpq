...
const columns = [
  ...
  columnHelper.accessor('value', {
    ...
    cell: (info) => {
      ...
      return formatPrice(info.getValue())
    },
  }),
...
function getTypeColor(type: string) {
  return type === 'PERCENTAGE' ? 'info' : 'success'
}

function getScopeColor(scope: string) {
  switch (scope) {
    case 'LINE_ITEM': return 'primary'
          ...
          <tr v-for="headerGroup in table.getHeaderGroups()" :key="headerGroup.id">
            <th
              ...
              :class="[
                ...
                header.column.id === 'type' && 'w-[12%]',
                header.column.id === 'value' && 'w-[12%]',
                header.column.id === 'scope' && 'w-[14%]',
                header.column.id === 'stackable' && 'w-[12%]',
        ...
        <tbody class="bg-white dark:bg-gray-950 divide-y divide-gray-200 dark:divide-gray-800">
          ...
          >
            ...
            >
              ...
              <template v-else-if="cell.column.id === 'scope'">
        ...
        <div class="flex items-start justify-between gap-3">
          <div class="min-w-0 flex-1">
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-0.5">
              {{ row.original.type === 'PERCENTAGE' ? `${row.original.value}%` : formatPrice(row.original.value) }}
            </p>
          </div>
          <div class="flex gap-1">
            <UButton
