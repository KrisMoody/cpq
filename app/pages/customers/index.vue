  ...
  <div class="space-y-6">
    <div class="flex items-center justify-between">
      <div>
        ...
        <p class="text-ga-gray-600">Manage your customer accounts</p>
      </div>
    ...
    <div v-else-if="filteredCustomers.length === 0" class="text-center py-12">
      <UIcon name="i-heroicons-user-group" class="w-12 h-12 text-ga-gray-400 mx-auto mb-4" />
      <p class="text-ga-gray-600 mb-4">No customers found</p>
