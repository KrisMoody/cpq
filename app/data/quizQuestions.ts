...
export const domainLabels: Record<QuizDomain, string> = {
  ...
  'course-beginner': 'Course: Beginner',
  'course-intermediate': 'Course: Intermediate',
...
export const quizQuestions: QuizQuestion[] = [
  ...
  // === COURSE: BEGINNER (Modules 00-02) ===
  {
    id: 'course-b-1',
    domain: 'course-beginner',
    question: 'What problem does each letter in CPQ solve?',
    type: 'single',
    options: [
      'Configure (valid combinations), Price (accurate calculation), Quote (proposal generation)',
      'Create (new products), Publish (to catalog), Query (customer data)',
      'Calculate (totals), Process (orders), Qualify (leads)',
      'Customize (UI), Prepare (reports), Quantify (metrics)',
    ],
    correctAnswers: [0],
    explanation: 'Configure ensures valid product combinations, Price calculates accurate pricing, and Quote generates professional proposal documents.',
  },
  {
    id: 'course-b-2',
    domain: 'course-beginner',
    question: 'Which industries commonly use CPQ systems?',
    type: 'multiple',
    options: [
      'Manufacturing (configurable products)',
      'SaaS (subscription tiers)',
      'Telecom (service bundles)',
      'Retail grocery (fixed pricing)',
    ],
    correctAnswers: [0, 1, 2],
    explanation: 'Manufacturing, SaaS, and Telecom all have complex pricing that benefits from CPQ. Retail grocery typically has simple fixed pricing that doesn\'t require CPQ.',
  },
  {
    id: 'course-b-3',
    domain: 'course-beginner',
    question: 'When would you use a BUNDLE vs STANDALONE product?',
    type: 'single',
    options: [
      'BUNDLE when customers make configuration choices; STANDALONE when sold as-is',
      'BUNDLE for single items; STANDALONE for multiple items',
      'BUNDLE for services; STANDALONE for physical products',
      'BUNDLE for expensive items; STANDALONE for cheap items',
    ],
    correctAnswers: [0],
    explanation: 'BUNDLE products require customer configuration (selecting options). STANDALONE products are sold as-is without any configuration choices.',
  },
  {
    id: 'course-b-4',
    domain: 'course-beginner',
    question: 'What does minOptions: 1, maxOptions: 1 mean on a feature?',
    type: 'single',
    options: [
      'The feature is optional',
      'The customer must choose exactly one option',
      'The feature has only one option available',
      'The feature can be selected multiple times',
    ],
    correctAnswers: [1],
    explanation: 'minOptions: 1 means at least one must be selected, maxOptions: 1 means at most one can be selected. Together, they require exactly one selection.',
  },
  {
    id: 'course-b-5',
    domain: 'course-beginner',
    question: 'How does an option reference what it sells?',
    type: 'single',
    options: [
      'Through the option name field',
      'Through optionProductId pointing to another Product',
      'Options don\'t reference products',
      'Through a direct price field on the option',
    ],
    correctAnswers: [1],
    explanation: 'Each option has an optionProductId that references another Product record, which has its own SKU and pricing.',
  },
  {
    id: 'course-b-6',
    domain: 'course-beginner',
    question: 'Why is the product-category relationship many-to-many?',
    type: 'single',
    options: [
      'It\'s not - products can only be in one category',
      'For database performance optimization',
      'A product can belong to multiple categories for flexible merchandising',
      'Categories can only have one product',
    ],
    correctAnswers: [2],
    explanation: 'A product can belong to multiple categories (e.g., "Hardware" AND "Work From Home"), enabling flexible catalog organization.',
  },
  {
    id: 'course-b-7',
    domain: 'course-beginner',
    question: 'How is MRR calculated for an ANNUAL product priced at $2,400/year?',
    type: 'single',
    options: [
      'MRR = $2,400 (the full amount)',
      'MRR = $2,400 × 12 = $28,800',
      'MRR = $2,400 / 12 = $200',
      'MRR = $2,400 / 4 = $600',
    ],
    correctAnswers: [2],
    explanation: 'MRR (Monthly Recurring Revenue) = Annual Price / 12 = $2,400 / 12 = $200 per month.',
  },

  // === COURSE: INTERMEDIATE (Modules 03-06, 09-10) ===
  {
    id: 'course-i-1',
    domain: 'course-intermediate',
    question: 'Why use attributes instead of adding columns to the Product table?',
    type: 'single',
    options: [
      'Attributes are faster to query',
      'Attributes allow extending product data without schema migrations',
      'Columns cannot store text values',
      'The Product table has a maximum column limit',
    ],
    correctAnswers: [1],
    explanation: 'Attributes allow extending product data without schema migrations, support varying metadata across product types, and enable dynamic filtering.',
  },
  {
    id: 'course-i-2',
    domain: 'course-intermediate',
    question: 'Why would you have multiple price books instead of just one with discounts?',
    type: 'single',
    options: [
      'You can\'t have discounts in CPQ',
      'Price books are required by law',
      'Price books enable systematic segmentation by customer type, region, or channel',
      'Discounts are more expensive to implement',
    ],
    correctAnswers: [2],
    explanation: 'Price books enable systematic segmentation (customer type, region, channel), different currencies, time-based pricing, and cleaner maintenance than per-quote discounting.',
  },
  {
    id: 'course-i-3',
    domain: 'course-intermediate',
    question: 'What\'s the difference between UNIT_PRICE and FLAT_PRICE tier types?',
    type: 'single',
    options: [
      'They are the same thing',
      'UNIT_PRICE: total = qty × tier price; FLAT_PRICE: total = tier price regardless of quantity',
      'UNIT_PRICE is for products; FLAT_PRICE is for services',
      'FLAT_PRICE is always cheaper',
    ],
    correctAnswers: [1],
    explanation: 'UNIT_PRICE charges per unit (10 units × $5 = $50). FLAT_PRICE is a fixed total for the tier regardless of quantity within the range.',
  },
  {
    id: 'course-i-4',
    domain: 'course-intermediate',
    question: 'In what order are price sources checked?',
    type: 'single',
    options: [
      'Default Price Book → Quote Price Book → Customer Price Book → Contract Price',
      'Contract Price → Customer Price Book → Quote Price Book → Default Price Book',
      'Quote Price Book → Default Price Book → Contract Price → Customer Price Book',
      'Customer Price Book → Contract Price → Default Price Book → Quote Price Book',
    ],
    correctAnswers: [1],
    explanation: 'The price resolution order is: Contract Price → Customer Price Book → Quote Price Book → Default Price Book.',
  },
  {
    id: 'course-i-5',
    domain: 'course-intermediate',
    question: 'What\'s the difference between customer price book assignment and a contract?',
    type: 'single',
    options: [
      'They are the same thing',
      'Price book gives access to a price list; contract provides negotiated fixed prices that override the price book',
      'Contracts are only for services',
      'Price books expire; contracts don\'t',
    ],
    correctAnswers: [1],
    explanation: 'Price book assignment gives the customer access to a specific price list. A contract provides negotiated fixed prices for specific products and/or a blanket discount that overrides the price book.',
  },
  {
    id: 'course-i-6',
    domain: 'course-intermediate',
    question: 'When does contract pricing apply to a quote?',
    type: 'single',
    options: [
      'Always, if a contract exists',
      'Only if the quote total exceeds a threshold',
      'When contract status is ACTIVE and current date is within start/end dates',
      'Only on the first quote for a customer',
    ],
    correctAnswers: [2],
    explanation: 'Contract pricing applies when: (1) customer has a contract, (2) contract status is ACTIVE, (3) current date is between startDate and endDate.',
  },
  {
    id: 'course-i-7',
    domain: 'course-intermediate',
    question: 'How does bundle pricing work in this PoC?',
    type: 'single',
    options: [
      'Bundle has its own price plus option prices',
      'Bundle parent has $0 price; all pricing comes from selected options',
      'Only the bundle price is used; options are free',
      'Customers choose between bundle or option pricing',
    ],
    correctAnswers: [1],
    explanation: 'Bundle parent has $0 price. All pricing comes from selected options (child lines). Total bundle price = sum of option prices.',
  },
  {
    id: 'course-i-8',
    domain: 'course-intermediate',
    question: 'What\'s the formula for netPrice on a quote line item?',
    type: 'single',
    options: [
      'netPrice = listPrice + discount',
      'netPrice = listPrice × quantity',
      'netPrice = quantity × (listPrice - discount)',
      'netPrice = (listPrice - discount) / quantity',
    ],
    correctAnswers: [2],
    explanation: 'netPrice = quantity × (listPrice - discount). This gives the extended price after discounts are applied.',
  },
  {
    id: 'course-i-9',
    domain: 'course-intermediate',
    question: 'What does "base currency" mean in CPQ?',
    type: 'single',
    options: [
      'The cheapest currency in the system',
      'The currency used for customer invoices',
      'The primary currency for consolidated reporting and analytics',
      'The currency set by the system administrator',
    ],
    correctAnswers: [2],
    explanation: 'Base currency is the primary currency for consolidated reporting and analytics. All quotes are converted to base currency for comparison.',
  },
  {
    id: 'course-i-10',
    domain: 'course-intermediate',
    question: 'Why store tax rate as Decimal(5,4) instead of a simple percentage?',
    type: 'single',
    options: [
      'To save storage space',
      'To maintain precision for rates like 8.875% without rounding errors',
      'Database requirement',
      'To support negative tax rates',
    ],
    correctAnswers: [1],
    explanation: 'To maintain precision. 8.25% = 0.0825 with 4 decimal places handles rates like 8.875% (0.08875) without rounding errors.',
  },

  // === COURSE: ADVANCED (Modules 07-08, 11-12) ===
  {
    id: 'course-a-1',
    domain: 'course-advanced',
    question: 'What\'s the difference between PERCENTAGE and FIXED_AMOUNT discounts?',
    type: 'single',
    options: [
      'PERCENTAGE is automatic; FIXED_AMOUNT is manual',
      'PERCENTAGE calculates as (price × rate/100); FIXED_AMOUNT is a flat dollar reduction',
      'PERCENTAGE is for products; FIXED_AMOUNT is for services',
      'There is no difference',
    ],
    correctAnswers: [1],
    explanation: 'PERCENTAGE calculates as (price × rate/100). FIXED_AMOUNT is a flat dollar reduction, capped at the item price.',
  },
  {
    id: 'course-a-2',
    domain: 'course-advanced',
    question: 'How does the system decide between stackable and non-stackable discounts?',
    type: 'single',
    options: [
      'It always uses stackable discounts',
      'It compares total stackable amount vs best non-stackable, applying whichever saves more',
      'The sales rep chooses manually',
      'Non-stackable discounts are applied first',
    ],
    correctAnswers: [1],
    explanation: 'The system compares total stackable discount amount vs best non-stackable amount, and applies whichever gives the customer more savings.',
  },
  {
    id: 'course-a-3',
    domain: 'course-advanced',
    question: 'What\'s the difference between CONFIGURATION and PRICING rules?',
    type: 'single',
    options: [
      'They are the same type of rule',
      'CONFIGURATION validates product combinations; PRICING modifies prices or triggers approval',
      'CONFIGURATION is manual; PRICING is automatic',
      'PRICING runs first; CONFIGURATION runs second',
    ],
    correctAnswers: [1],
    explanation: 'CONFIGURATION rules validate product combinations (require/exclude products). PRICING rules modify prices or trigger approval workflows.',
  },
  {
    id: 'course-a-4',
    domain: 'course-advanced',
    question: 'When would ON_FINALIZE trigger instead of ON_QUOTE_SAVE?',
    type: 'single',
    options: [
      'They trigger at the same time',
      'ON_FINALIZE triggers on every save',
      'ON_QUOTE_SAVE fires on every save; ON_FINALIZE fires only when submitting for approval',
      'ON_QUOTE_SAVE is for configuration; ON_FINALIZE is for pricing',
    ],
    correctAnswers: [2],
    explanation: 'ON_QUOTE_SAVE fires on every save (draft updates). ON_FINALIZE fires only when submitting for approval/customer - used for final validation.',
  },
  {
    id: 'course-a-5',
    domain: 'course-advanced',
    question: 'What\'s the difference between CROSS_SELL and UPSELL affinity types?',
    type: 'single',
    options: [
      'They are the same thing',
      'CROSS_SELL recommends complementary products; UPSELL recommends a premium version',
      'CROSS_SELL is mandatory; UPSELL is optional',
      'UPSELL is for bundles; CROSS_SELL is for standalone products',
    ],
    correctAnswers: [1],
    explanation: 'CROSS_SELL recommends complementary products (laptop → monitor). UPSELL recommends a premium version of what they\'re already buying (Basic → Pro).',
  },
  {
    id: 'course-a-6',
    domain: 'course-advanced',
    question: 'Why use category-level affinities instead of product-level?',
    type: 'single',
    options: [
      'Category-level affinities are faster',
      'Product-level affinities are not supported',
      'To avoid creating individual affinities for every product combination',
      'Category-level affinities have higher priority',
    ],
    correctAnswers: [2],
    explanation: 'To avoid creating individual affinities for every product combination. One category affinity can cover hundreds of product pairs.',
  },
  {
    id: 'course-a-7',
    domain: 'course-advanced',
    question: 'What\'s the purpose of RecommendationLog?',
    type: 'single',
    options: [
      'To store product descriptions',
      'To track which recommendations are shown, accepted, or dismissed for optimization',
      'To log system errors',
      'To store quote history',
    ],
    correctAnswers: [1],
    explanation: 'RecommendationLog tracks effectiveness of recommendations - which are shown, accepted, or dismissed. This data improves future recommendations.',
  },
  {
    id: 'course-a-8',
    domain: 'course-advanced',
    question: 'What does entityId enable in the data model?',
    type: 'single',
    options: [
      'Product categorization',
      'Multi-tenancy through row-level isolation',
      'Version control',
      'User authentication',
    ],
    correctAnswers: [1],
    explanation: 'entityId enables multi-tenancy through row-level isolation. Each tenant\'s data is segregated by entityId, allowing multiple organizations to share the same database.',
  },
  {
    id: 'course-a-9',
    domain: 'course-advanced',
    question: 'What\'s the benefit of quote layout templates?',
    type: 'single',
    options: [
      'They reduce database size',
      'They speed up quote calculation',
      'Reusable presentation formats for consistent branding across proposals',
      'They enable multi-currency support',
    ],
    correctAnswers: [2],
    explanation: 'Quote layout templates provide reusable presentation formats. Create a template once, use for multiple quotes. Ensures consistent branding and formatting.',
  },
  {
    id: 'course-a-10',
    domain: 'course-advanced',
    question: 'What should typically be the first production integration for a CPQ system?',
    type: 'single',
    options: [
      'ERP system',
      'Email marketing platform',
      'CRM, as it\'s the source of customer and opportunity data',
      'Inventory management',
    ],
    correctAnswers: [2],
    explanation: 'Typically CRM, as it\'s the source of customer and opportunity data. Quote creation often starts from CRM context.',
  },
]
